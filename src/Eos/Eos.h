...
class Eos
{
  public:
    ...
    double
    computeTotalEnthalpy(const double& density, const double& pressure, const double& velX, const double& velY = 0., const double& velZ = 0.) const;
    //! \brief    Compute the total enthalpy of the phase
    //! \param    density         density (\f$\rho \f$)
    //! \param    pressure        pressure (p)
    ...
    //! \brief See derived classes
    virtual double computeTemperature(const double& /*density*/, const double& /*pressure or energy*/) const
    {
      Errors::errorMessage("computeTemperature not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeEnergy(const double& /*density*/, const double& /*pressure or temperature*/) const
    {
      Errors::errorMessage("computeEnergy not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computePressure(const double& /*density*/, const double& /*energy or temperature*/) const
    {
    ...
    {
      Errors::errorMessage("computeInterfaceSoundSpeed not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeAcousticImpedance(const double& /*density*/, const double& /*pressure*/) const
    {
      Errors::errorMessage("computeAcousticImpedance not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double
    computeDensityTimesInterfaceSoundSpeedSquare(const double& /*density*/, const double& /*interfacePressure*/, const double& /*pressure*/) const
    {
      Errors::errorMessage("computeDensityTimesInterfaceSoundSpeedSquare not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeEntropy(const double& /*temperature*/, const double& /*pressure*/) const
    {
      Errors::errorMessage("computeEntropy not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    ...
    {
      Errors::errorMessage("computePressureIsentropic not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    ...
    {
      Errors::errorMessage("computePressureHugoniot not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeDensityIsentropic(const double& /*initialPressure*/,
                                            const double& /*initialDensity*/,
                                            const double& /*finalPressure*/,
                                            double* /*drhodp*/ = 0) const
    {
      Errors::errorMessage("computeDensityIsentropic not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeDensityHugoniot(const double& /*initialPressure*/,
                                          const double& /*initialDensity*/,
                                          const double& /*finalPressure*/,
                                          double* /*drhodp*/ = 0) const
    {
      Errors::errorMessage("computeDensityHugoniot not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double computeDensityPfinal(const double& /*initialPressure*/,
                                        const double& /*initialDensity*/,
                                        const double& /*finalPressure*/,
                                        double* /*drhodp*/ = 0) const
    {
      Errors::errorMessage("computeDensityPfinal not yet programmed for EOS : " + m_name);
      return 0.;
    };

    //! \brief See derived classes
    virtual double computeEnthalpyIsentropic(const double& /*initialPressure*/,
                                             const double& /*initialDensity*/,
                                             const double& /*finalPressure*/,
                                             double* /*dhdp*/ = 0) const
    {
      Errors::errorMessage("computeEnthalpyIsentropic not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double
    computeDensitySaturation(const double& /*pressure*/, const double& /*Tsat*/, const double& /*dTsatdP*/, double* /*drhodp*/ = 0) const
    {
      Errors::errorMessage("computeDensitySaturation not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double
    computeDensityEnergySaturation(const double& /*pressure*/, const double& /*rho*/, const double& /*drhodp*/, double* /*drhoedp*/ = 0) const
    {
      Errors::errorMessage("computeDensityEnergySaturation not available for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual void
    sendSpecialMixtureEos(double& /*gamPinfOverGamMinusOne*/, double& /*eRef*/, double& /*oneOverGamMinusOne*/, double& /*covolume*/) const
    {
      Errors::errorMessage("sendSpecialMixtureEos not yet programmed for EOS : " + m_name);
    };
    //! \brief See derived classes
    virtual double vfpfh(const double& /*pressure*/, const double& /*enthalpy*/) const
    {
      Errors::errorMessage("vfpfh not yet programmed for EOS : " + m_name);
      return 0.;
    };
    ...
    {
      Errors::errorMessage("dvdpch not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double dvdhcp(const double& /*pressure*/) const
    {
      Errors::errorMessage("dvdhcp not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double drhodpcT(const double& /*pressure*/, const double& /*temperature*/) const
    {
      Errors::errorMessage("drhodpcT not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double dedrho(const double& /*density*/, const double& /*temperature*/) const
    {
      Errors::errorMessage("dedrho not yet programmed for EOS : " + m_name);
      return 0.;
    };
    //! \brief See derived classes
    virtual double dedrhoSecond(const double& /*density*/, const double& /*temperature*/) const
    {
      Errors::errorMessage("dedrhoSecond not yet programmed for EOS : " + m_name);
      return 0.;
    };
    ...
    {
      Errors::errorMessage("verifyPressure not yet programmed Eos : " + m_name);
    };
    //! \brief See derived classes
    virtual void verifyAndModifyPressure(double& /*pressure*/) const
    {
      Errors::errorMessage("verifyAndModifyPressure not yet programmed Eos : " + m_name);
    };
    //! \brief See derived classes
    virtual void verifyAndCorrectDensityMax(const double& /*mass*/, double& /*alpha*/, double& /*density*/) const
    {
      Errors::errorMessage("verifyAndCorrectDensityMax not yet programmed Eos : " + m_name);
    };
    //! \brief See derived classes
...
extern double
  epsilonAlphaNull; //!< Epsilon value to avoid division by 0 when alpha = 0 is activated. If alpha = 0 desactivated, i.e. alpha != 0, then epsilonAlphaNull = 0.
